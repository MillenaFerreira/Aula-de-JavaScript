...
const getCapitalPais = function () {
   ...
   let listCapitaisJSON = {};

   let listCapitaisArray = [];

   listCapitaisJSON.capitais = listCapitaisArray;

   estadosCidades.estados.forEach(function (dadosCapitais) {

      if (dadosCapitais.capital_pais) {
         let listDadosCapitais = {};

         listDadosCapitais.capital_atual = dadosCapitais.capital_pais.capital
         listDadosCapitais.uf = dadosCapitais.sigla
         listDadosCapitais.descricao = dadosCapitais.nome
         listDadosCapitais.capital = dadosCapitais.capital
         listDadosCapitais.regiao = dadosCapitais.regiao
         listDadosCapitais.capital_pais_ano_inicio = dadosCapitais.capital_pais.ano_inicio
         listDadosCapitais.capital_pais_ano_termino = dadosCapitais.capital_pais.ano_fim
...
const getCidades = function(sigla){
   ...
   estadosCidades.estados.forEach(function (dados) {
      ...
      //verifica a se a sigla está em 
      if (uf === dados.sigla) {
         listCidadesJSON.uf = dados.sigla
         listCidadesJSON.descricao = dados.nome
