...
const getRegiao = function (regiao) {
   ...
   //Criando um json para ficar dentro array(listRegiaoArray)
   //let listDados = {};

   //Adicionando o array(listRegiaoArray) dentro de um JSON(listRegiaoJSON)
   listRegiaoJSON.regiao = regioes
   listRegiaoJSON.estados = listRegiaoArray

   //adicionando um JSON(listDados) dentro de um array(listRegiaoArray)
   //listRegiaoArray.estados = listDados;
   ...
   estadosCidades.estados.forEach(function (dados) {
      ...
      if (regioes === dados.regiao) {
         ...
         //adicionando dentro 
         listRegiaoArray.uf = dados.sigla
         listRegiaoArray.descricao = dados.nome
      } else {
         return false;
      }
